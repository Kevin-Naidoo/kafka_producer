...
config :kafka_cluster, KafkaClusterWeb.Endpoint,
  ...
  http: [ip: {0, 0, 0, 0}, port: 4080],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "H1CLk/0MeFNmywPBW7gQ75H7EMNnssoRXez3GvFk984O8eu4SmRlO5fNcMv3bDUP",
  watchers: [
...
config :kafka_cluster, KafkaClusterWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/kafka_cluster_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :kafka_cluster, dev_routes: true
